...
//VAO_START RELPACE
// This declaration was not present in v1.6, and hence does not come directly
// from the diff of v1.6 with SharedAppVNC. But since the signature of this
// method was changed, we need to make it consistent everywhere.
//extern void connectReverseClient(char *hostName, int portNum);
//VAO_BY
extern rfbClientPtr connectReverseClient(char *hostName, int portNum);
//VAO_END
